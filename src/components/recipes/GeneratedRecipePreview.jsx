...
import { X, Save, RefreshCw, Clock, Flame, Users } from 'lucide-react';

export default function GeneratedRecipePreview({ recipe, isOpen, onClose, onSave, onRegenerate, isSaving }) {
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-6">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                {recipe.cuisine_inspiration && (
                  <p className="text-emerald-100 text-sm">{recipe.cuisine_inspiration} inspired</p>
                )}
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              <Badge className="bg-white/20 text-white border-0">{recipe.meal_type}</Badge>
